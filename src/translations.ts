...
export interface TranslationSet {
  ...
  settingsGlyphTooltipsLabel: string;
  settingsDataSoundLabel: string;
...
export const translations: Record<SupportedLanguage, TranslationSet> = {
  en: {
    ...
    generalRandomRegionGlyphsBtn: "Generate Glyphs for Region",
    ...
    settingsTextScaleLabel: "Font Scale",
    settingsScaleDefault: "1x (Default)",
    settingsGlyphTooltipsLabel: "Glyph Tooltips",
    settingsDataSoundLabel: "Data SFX",
    tooltipsEnabled: "Tooltips: ON",
    tooltipsDisabled: "Tooltips: OFF",
  ...
  es: {
    ...
    settingsGlyphTooltipsLabel: "Descripciones emergentes de glifos",
    settingsDataSoundLabel: "SFX de Datos",
    tooltipsEnabled: "Descripciones: ACTIVADAS",
    tooltipsDisabled: "Descripciones: DESACTIVADAS",
  ...
  fr: {
    ...
    settingsGlyphTooltipsLabel: "Info-bulles des glyphes",
    settingsDataSoundLabel: "SFX de Données",
    tooltipsEnabled: "Info-bulles: ACTIVÉES",
    tooltipsDisabled: "Info-bulles: DÉSACTIVÉES",
  ...
  de: {
    ...
    settingsGlyphTooltipsLabel: "Glyphen-Tooltips",
    settingsDataSoundLabel: "Daten-SFX",
    tooltipsEnabled: "Tooltips: EIN",
    tooltipsDisabled: "Tooltips: AUS",
  ...
  pt: {
    ...
    settingsGlyphTooltipsLabel: "Dicas de ferramentas de glifos",
    settingsDataSoundLabel: "SFX de Dados",
    tooltipsEnabled: "Dicas: ATIVADAS",
    tooltipsDisabled: "Dicas: DESATIVADAS",
  ...
  it: {
    ...
    settingsGlyphTooltipsLabel: "Tooltip dei glifi",
    settingsDataSoundLabel: "SFX Dati",
    tooltipsEnabled: "Tooltip: ATTIVI",
    tooltipsDisabled: "Tooltip: DISATTIVI",
  ...
  th: {
    ...
    settingsGlyphTooltipsLabel: "ทูลทิปสัญลักษณ์",
    settingsDataSoundLabel: "เสียงเอฟเฟกต์ข้อมูล",
    tooltipsEnabled: "ทูลทิป: เปิด",
    tooltipsDisabled: "ทูลทิป: ปิด",
  ...
  hi: {
    ...
    settingsGlyphTooltipsLabel: "ग्लिफ़ टूलटिप",
    settingsDataSoundLabel: "डेटा ध्वनि प्रभाव",
    tooltipsEnabled: "टूलटिप: चालू",
    tooltipsDisabled: "टूलटिप: बंद",
  ...
  zh: {
    ...
    settingsGlyphTooltipsLabel: "符文提示框",
    settingsDataSoundLabel: "数据音效",
    tooltipsEnabled: "提示框：开启",
    tooltipsDisabled: "提示框：关闭",
  ...
  ja: {
    ...
    settingsGlyphTooltipsLabel: "グリフのツールチップ",
    settingsDataSoundLabel: "データ効果音",
    tooltipsEnabled: "ツールチップ：オン",
    tooltipsDisabled: "ツールチップ：オフ",
...
export const glyphTranslations: Record<SupportedLanguage, Record<string, LocalizedGlyph>> = {
  en: {
    ...
    '7': { name: 'Beetle', desc: 'The Beetle key, representing hard-shelled lifeforms.' },
    '8': { name: 'Dragonfly', desc: 'The Dragonfly or insect glyph, represents lightweight micro-flight.' },
  ...
  es: {
    ...
    '7': { name: 'Escarabajo', desc: "La tecla del Escarabajo, que representa formas de vida con caparazón duro." },
    '8': { name: 'Libélula', desc: "El glifo de la Libélula o insecto, que representa el microvuelo ligero." },
  ...
  fr: {
    ...
    '7': { name: 'Scarabée', desc: "La clé du Scarabée, représentant des formes de vie à carapace dure." },
    '8': { name: 'Libellule', desc: "Le glyphe de la Libellule ou de l'insecte, représentant un vol léger." },
  ...
  de: {
    ...
    '7': { name: 'Käfer', desc: "Die Käfer-Glyphe symbolisiert hartschalige Lebensformen." },
    '8': { name: 'Libelle', desc: "Die Libellen- oder Insekten-Glyphe repräsentiert leichten Mikroflug." },
  ...
  pt: {
    ...
    '7': { name: 'Besouro', desc: "O símbolo do Besouro, representando formas de vida com carapaça dura." },
    '8': { name: 'Libélula', desc: "O glifo da Libélula ou inseto, representa voos leves de escala reduzida." },
  ...
  it: {
    ...
    '7': { name: 'Coleottero', desc: "Il tasto Coleottero, che rappresenta forme di vita dotate di guscio rigido." },
    '8': { name: 'Libellula', desc: "Il glifo Libellula o insetto, che rappresenta il microvolo leggero." },
  ...
  th: {
    ...
    '7': { name: 'ด้วง (Beetle)', desc: 'สัญลักษณ์ด้วง แสดงถึงสิ่งมีชีวิตที่มีเปลือกนอกแข็งแกร่ง' },
    '8': { name: 'แมลงปอ (Dragonfly)', desc: 'สัญลักษณ์แมลงปอ แสดงถึงการบินร่อนขนาดเล็กที่มีน้ำหนักเบา' },
  ...
  hi: {
    ...
    '7': { name: 'भृंग (Beetle)', desc: "बीटल कुंजी, कठोर खोल वाले जीवों का प्रतिनिधित्व करती है।" },
    '8': { name: 'व्याध-पतंग (Dragonfly)', desc: "ड्रैगनफ्लाई या कीट ग्लिफ, हल्के वजन वाले सूक्ष्म उड़ान का प्रतिनिधित्व करता है।" },
  ...
  zh: {
    ...
    '7': { name: '甲虫 (Beetle)', desc: "甲虫符文，代表硬壳生命形式。" },
    '8': { name: '蜻蜓 (Dragonfly)', desc: "蜻蜓或昆虫符文，代表轻量级微型飞行物。" },
  ...
  ja: {
    ...
    '7': { name: 'カブトムシ (Beetle)', desc: "甲虫のキー。硬い殻を持つ生命体を表します。" },
    '8': { name: 'トンボ (Dragonfly)', desc: "トンボまたは昆虫のグリフ。軽量な微小飛行体を表します。" },
